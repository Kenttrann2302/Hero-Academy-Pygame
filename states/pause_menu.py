...
class PauseMenu(State):
    def __init__(self, game):
        ...
        self.menu_rect_center = (self.game.GAME_W*.85, self.game.GAME_H*.4)
        # set the cursors and menu states
        self.menu_options = {0: "Party", 1: "Items", 2: "Magic", 3: "Multiplayer", 4: "Exit"}
        self.index = 0
    ...
    def transition_state(self):
        if self.menu_options[self.index] == "Party":
            ...
            pass #still in development the items menu
        elif self.menu_options[self.index] == "Magic":
            pass # still in development for the magic menu
        elif self.menu_options[self.index] == "Multiplayer":
            pass # still in development the multiplayer function
